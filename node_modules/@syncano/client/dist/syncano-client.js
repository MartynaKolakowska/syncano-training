var SyncanoClient = function(e) {
    ...
    function forEach(e, t) {
        if (null !== e && void 0 !== e) if ("object" != typeof e && (e = [ e ]), isArray(e)) for (var n = 0, r = e.length; n < r; n++) t.call(null, e[n], n, e); else for (var o in e) Object.prototype.hasOwnProperty.call(e, o) && t.call(null, e[o], o, e);
    }
    function merge() {
    ...
    var r = n(2), o = n(14), i = Object.prototype.toString;
    e.exports = {
        isArray: isArray,
    ...
    (function(t) {
        ...
        var r = n(0), o = n(16), i = {
            ...
            transformRequest: [ function(e, t) {
                return o(t, "Content-Type"), r.isFormData(e) || r.isArrayBuffer(e) || r.isBuffer(e) || r.isStream(e) || r.isFile(e) || r.isBlob(e) ? e : r.isArrayBufferView(e) ? e.buffer : r.isURLSearchParams(e) ? (setContentTypeIfUnset(t, "application/x-www-form-urlencoded;charset=utf-8"), 
    ...
    function cleanUpNextTick() {
        a && i && (a = !1, i.length ? u = i.concat(u) : s = -1, u.length && drainQueue());
    }
    function drainQueue() {
        if (!a) {
    ...
    o.nextTick = function(e) {
        ...
        u.push(new Item(e, t)), 1 !== u.length || a || runTimeout(drainQueue);
    ...
    o.removeListener = noop, o.removeAllListeners = noop, o.emit = noop, o.prependListener = noop, 
    o.prependOnceListener = noop, o.listeners = function(e) {
        return [];
    ...
    "use strict";
    (function(t) {
        var r = n(0), o = n(17), i = n(19), u = n(20), a = n(21), s = n(5), c = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || n(22);
        e.exports = function(e) {
            return new Promise(function(f, l) {
                var p = e.data, d = e.headers;
                r.isFormData(p) && delete d["Content-Type"];
                var h = new XMLHttpRequest(), m = "onreadystatechange", y = !1;
                if ("test" === t.env.NODE_ENV || "undefined" == typeof window || !window.XDomainRequest || "withCredentials" in h || a(e.url) || (h = new window.XDomainRequest(), 
                ...
                h.timeout = e.timeout, h[m] = function() {
                    if (h && (4 === h.readyState || y) && (0 !== h.status || h.responseURL && 0 === h.responseURL.indexOf("file:"))) {
                        var t = "getAllResponseHeaders" in h ? u(h.getAllResponseHeaders()) : null, n = e.responseType && "text" !== e.responseType ? h.response : h.responseText, r = {
                            data: n,
                    ...
                    var w = n(23), b = (e.withCredentials || a(e.url)) && e.xsrfCookieName ? w.read(e.xsrfCookieName) : void 0;
    ...
    function SyncanoClient() {
        function client() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : required("endpoint"), t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, r = t._method || "POST", i = client.headers(n.headers), u = client.url(e), a = {}, c = t;
            delete a._method, "GET" === r && (c = {}, a = t);
            var l = [ function(e) {
                return e instanceof f.default ? e : JSON.stringify(e);
            } ];
        ...
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : required("instanceName"), t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = t.host || "syncano.space", i = {
        ...
        client.token = t.token, client.headers = function(e) {
            ...
            return (client.loginMethod ? client.loginMethod : function(e, t) {
                var n = "https://api.syncano.io/v2/instances/" + client.instanceName + "/users/auth/", r = JSON.stringify({
                    username: e,
                    password: t
                });
                return (0, s.default)({
                    ...
                    return client.setToken(e.token), e;
                });
            })(e, t);
        }, client.url = function(e, t) {
            var n = "" + this.baseUrl + e + "/?";
            return t && (n += u.default.stringify(t) + "&"), client.token && (n += "user_key=" + client.token), 
            n;
        ...
        }, client.setLastId = function(e, t) {
            var n = this.url(e + "/history", t);
            if (!t.last_id) return (0, s.default)(n).then(function(e) {
                var t = e.data.objects[0];
                return t ? t.id : null;
            });
        }, client.subscribe = function() {
            function loop() {
                o || (0, s.default)(f, c).then(function(n) {
                    l(n.data), t.last_id = n.data.id, f = client.url(e, t), loop();
                }).catch(function(e) {
                    var t = /(Network Error)|(timeout)/.test(e), n = !1 === o;
                    t && n && loop();
                });
            }
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : required("endpoint"), t = arguments[1], n = arguments[2], o = !1, i = "object" === (void 0 === t ? "undefined" : r(t)) && null !== t, u = t, a = {};
            delete u._method;
            var c = {
                timeout: 3e5,
                ...
                params: u,
                data: a
            }, f = client.url(e, t), l = i ? n : t;
            return client.setLastId(e, t).then(function(n) {
                t.last_id = n, f = client.url(e, t), loop();
            }), {
                stop: function() {
                    o = !0;
                }
            ...
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : required("endpoint"), t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments[2], o = "object" === (void 0 === t ? "undefined" : r(t)) && null !== t, i = o ? n : t, u = client.subscribe(e, o ? t : {}, function(e) {
                u.stop(), i(e);
            });
        }, client;
    }
    ...
    var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
        ...
        return e;
    }, i = n(9), u = _interopRequireDefault(i), a = n(12), s = _interopRequireDefault(a), c = n(31), f = _interopRequireDefault(c);
    t.default = SyncanoClient, e.exports = t.default;
}, function(e, t, n) {
    "use strict";
    ...
    e.exports = function(e, t, n, o) {
        ...
        a > 0 && s > a && (s = a);
        for (var c = 0; c < s; ++c) {
            var f, l, p, d, h = e[c].replace(u, "%20"), m = h.indexOf(n);
            m >= 0 ? (f = h.substr(0, m), l = h.substr(m + 1)) : (f = h, l = ""), p = decodeURIComponent(f), 
            d = decodeURIComponent(l), hasOwnProperty(i, p) ? r(i[p]) ? i[p].push(d) : i[p] = [ i[p], d ] : i[p] = d;
        }
        return i;
    };
    ...
    var r = n(0), o = n(2), i = n(15), u = n(1), a = createInstance(u);
    a.Axios = i, a.create = function(e) {
        return createInstance(r.merge(u, e));
    }, a.Cancel = n(7), a.CancelToken = n(29), a.isCancel = n(6), a.all = function(e) {
        return Promise.all(e);
    }, a.spread = n(30), e.exports = a, e.exports.default = a;
}, function(e, t) {
    function isBuffer(e) {
    ...
    function btoa(e) {
        for (var t, n, o = String(e), i = "", u = 0, a = r; o.charAt(0 | u) || (a = "=", 
        u % 1); i += a.charAt(63 & t >> 8 - u % 1 * 8)) {
            if ((n = o.charCodeAt(u += .75)) > 255) throw new E();
            t = t << 8 | n;
        }
        return i;
    }
    ...
    var r = n(0), o = n(26), i = n(6), u = n(1), a = n(27), s = n(28);
    e.exports = function(e) {
        return throwIfCancellationRequested(e), e.baseURL && !a(e.url) && (e.url = s(e.baseURL, e.url)), 
        e.headers = e.headers || {}, e.data = o(e.data, e.headers, e.transformRequest), 
