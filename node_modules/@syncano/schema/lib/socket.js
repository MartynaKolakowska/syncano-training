          ...
          items: {
            ...
            'switch': [{
              if: {
                properties: {
                  type: {
                    oneOf: [{ const: 'reference' }, { const: 'relation' }]
                  }
                }
              },
              ...
              if: {
                properties: {
                  type: {
                    oneOf: [{ const: 'text' }, { const: 'file' }, { const: 'object' }]
                  }
                }
              },
              then: {
              ...
              if: {
                properties: {
                  type: {
                    oneOf: [{ const: 'array' }, { const: 'geopoint' }, { const: 'relation' }]
                  }
                }
              },
              then: {
            ...
            properties: {
              ...
              type: {
                type: 'string',
                enum: ['string', 'text', 'integer', 'float', 'boolean', 'datetime', 'file', 'reference', 'relation', 'array', 'object', 'geopoint']
              }
            },
            required: ['name', 'type']
          }
