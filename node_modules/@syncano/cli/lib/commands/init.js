...
class InitCmd {
  ...
  run([cmd]) {
    ...
    return _asyncToGenerator(function* () {
      const { project, settings } = _this.session;
      const { instance } = cmd;

      if (process.env.INIT_CWD) {
        (0, _analytics.track)('CLI: install');
      }
      ...
      if (!project && instance) {
        ...
        (0, _printTools.echo)(4)(`Your project is attached to ${_chalk2.default.green(instance.name)} instance now!`);
      ...
      if (!project && !instance) {
        ...
        const newInstance = yield (0, _createInstance.createInstance)();

        yield _this.init.addConfigFiles({ instance: newInstance.name });
        (0, _printTools.echo)(4)(`Your project is attached to ${_chalk2.default.green(newInstance.name)} instance now!`);
