...
class BackupsLast {
  ...
  run() {
    ...
    return _asyncToGenerator(function* () {
      try {
        const backup = yield _this.Backups.last();
        ...
        (0, _printTools.echo)(4)(`${_chalk2.default.dim('created at')}: ${_this.dateParser(createAt)}`);
        (0, _printTools.echo)(4)(`${_chalk2.default.dim('updated at')}: ${_this.dateParser(updatedAt)}`);
...
exports.default = BackupsLast;
module.exports = exports['default'];
//# sourceMappingURL=backups-last.js.map