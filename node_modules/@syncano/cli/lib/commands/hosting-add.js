...
class HostingAdd {
  ...
  run([folder, cmd]) {
    ...
    return _asyncToGenerator(function* () {
      _this.folder = folder;
      _this.hostingName = cmd.hostingName || null;
      _this.browserRouter = cmd.browserRouterOn || cmd.browserRouterOff || null;
      _this.sync = cmd.dontSync ? false : cmd.sync || null;
      _this.cname = cmd.withoutCname ? false : cmd.cname || null;
      _this.fullPath = null;
  ...
  syncNewHosting() {
    ...
    return _asyncToGenerator(function* () {
      if (_this2.sync == null) {
        ...
        _this2.sync = response.confirm || _this2.sync;
      }

      (0, _printTools.echo)();
      if (!_this2.sync) {
        (0, _printTools.echo)(4)(`To sync files use: ${_chalk2.default.cyan(`npx s hosting sync ${_this2.hostingName}`)}`);
        (0, _printTools.echo)();
        return process.exit();
      }
