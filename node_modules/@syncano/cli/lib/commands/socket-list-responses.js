...
const socketListResponses = session => ({
  ...
  createNewOne: `Type ${_chalk2.default.cyan('npx s create <name>')} to create new one.`,
  installNewOne: `Type ${_chalk2.default.cyan('npm install <name>')} to install new one from NPM registry.`,
