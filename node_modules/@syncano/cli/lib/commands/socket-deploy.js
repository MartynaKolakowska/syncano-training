...
class SocketDeployCmd {
  ...
  run([socketName, cmd]) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (cmd.createInstance) {
        ...
        (0, _printTools.echo)(4)(`Your project is attached to ${_chalk2.default.green(cmd.createInstance)} instance now!`);
      } else {
  ...
  deploySocket(socket, config) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        const updateStatus = yield socket.update({
          config,
