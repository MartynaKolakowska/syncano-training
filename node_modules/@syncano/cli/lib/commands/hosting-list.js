...
class HostingListCmd {
  ...
  static printNoHostingsInfo() {
    ...
    (0, _printTools.echo)(4)(`Type ${_chalk2.default.cyan('npx s hosting add')} to add hosting for your app!`);
    (0, _printTools.echo)();
  }
  ...
  static printHosting(hosting) {
    ...
    (0, _printTools.echon)(2)(`   ${_chalk2.default.dim('local path')}:`);
    (0, _printTools.echo)(` ${_chalk2.default.cyan(hosting.src)}`);
    ...
    if (hosting.error) {
      const errorResponses = {
        404: `Type ${_chalk2.default.green(`npx s hosting sync ${hosting.name}`)} to sync your hosting with server.`
      };
