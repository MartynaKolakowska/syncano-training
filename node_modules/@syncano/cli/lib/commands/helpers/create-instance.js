...
const { debug } = (0, _debug2.default)('cmd-helpers-create-instance');
  ...
  var _ref = _asyncToGenerator(function* (instanceName) {
    ...
    try {
      ...
      if (err.message === 'No such API Key.') {
        ...
        (0, _printTools.echo)(4)(`Try ${_chalk2.default.cyan('npx s logout')} and ${_chalk2.default.cyan('npx s login')} again.`);
