    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        if (cmd.socket) {
          ...
          yield _this.socket.addDependency(socketFromRegistry);
        } else {
          // Project dependency
        ...
        if (err.response) {
          if (err.response.status === 404) {
            (0, _printTools.echo)();
            (0, _printTools.echo)(4)('No socket found 😕');
          ...
          (0, _printTools.echo)();
          if (err.message) {
            (0, _printTools.echo)(`${_chalk2.default.red(err.message)}\n`);
          } else {
...
exports.default = SocketAdd;
module.exports = exports['default'];
//# sourceMappingURL=socket-add.js.map