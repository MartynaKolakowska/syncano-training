...
class Session {
  ...
  createConnection() {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        _this.userFirstName = details.first_name;
        _this.userLastName = details.last_name;
      } catch (err) {}
    })();
  }
  ...
  isAuthenticated() {
    if (!this.settings.account.authenticated()) {
      ...
      (0, _printTools.echo)(4)(`Type ${_chalk2.default.cyan('npx s login')} for login to your account.`);
      (0, _printTools.echo)();
      process.exit(1);
    }
  }
  ...
  checkConnection(instanceName) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        instance = yield _this8.getInstance(instanceName);
      } catch (err) {
        debug(err.message);
        if (err.message === 'Not found.') {
          ...
          (0, _printTools.echo)(4)(`Type ${_chalk2.default.cyan('npx s attach')} to choose one of the existing instances.`);
          (0, _printTools.echo)();
        }
        process.exit(1);
      }
  ...
  hasProject() {
    ...
    if (!this.project) {
      ...
      (0, _printTools.echo)(4)(`Try ${_chalk2.default.cyan('npx s attach')}.`);
      (0, _printTools.echo)();
      process.exit();
    }
  }
  ...
  hasProjectPath() {
    if (!this.projectPath) {
      (0, _printTools.echo)();
      (0, _printTools.echo)(4)(`I don't see any project here. Try ${_chalk2.default.cyan('npx s init')}.`);
      (0, _printTools.echo)();
      process.exit();
    }
  }
  ...
  hasSocket(socketName) {
    ...
    if (!socket.existLocally) {
      ...
      (0, _printTools.echo)(4)(`Check your directory or try ${_chalk2.default.cyan('npx s create')} to create a new Socket.`);
      (0, _printTools.echo)();
      process.exit();
    }
  }
  ...
  notAlreadyInitialized() {
    if (this.projectPath && this.project) {
      (0, _printTools.echo)();
      (0, _printTools.echo)(4)('Project in this folder is already initiated!');
      (0, _printTools.echo)(4)(`It is attached to ${_chalk2.default.cyan(this.project.instance)} Syncano instance.`);
      (0, _printTools.echo)();
      process.exit();
    }
  }
