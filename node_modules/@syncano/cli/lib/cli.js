...
const setup = (() => {
  var _ref = _asyncToGenerator(function* () {
    ...
    _program2.default.command('info').group('Basics').description('Info about current project/instance/user etc.').action((() => {
      var _ref2 = _asyncToGenerator(function* (...options) {
        trackAndDebug(options);
        new _commands2.default.Info(_context2.default).run(options);
      });
    ...
    _program2.default.command('attach').group('Basics').description('Attach project to the chosen Instance').option('-i, --instance <name>', 'Instance you want to use for your project').option('-c, --create-instance <name>', 'Create instance you want to use for your project').action((() => {
    ...
    _program2.default.command('sysinfo').group('Basics').description('Sys info for debug purpose').action(function (...options) {
      trackAndDebug(options);
      new _commands2.default.SysInfo(_context2.default).run(options);
    });
    ...
    _program2.default.command('compile [socket_name]').group('Project').description('Compile Socket').action((() => {
      var _ref7 = _asyncToGenerator(function* (...options) {
        trackAndDebug(options);
        (0, _printTools.echo)();
        new _commands2.default.SocketCompile(_context2.default).run(options);
      });
    ...
    _program2.default.command('list [socket_name]').group('Sockets').description('List the installed Sockets').option('-f, --full', 'Print the detailed information (including parameters and response)').action((() => {
    ...
    _program2.default.command('backup', 'Menage your backups').on('*', function (commandsArr) {
