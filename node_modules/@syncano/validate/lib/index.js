...
var _schema = require('@syncano/schema');
...
class Validator {
  ...
  static validateMainSchema(schemaToTest) {
    const ajv = new _ajv2.default({ coerceTypes: true });
    (0, _ajvKeywords2.default)(ajv, ['prohibited', 'switch']);
    ...
    Validator.validate(_schema.socketSchema, schemaToTest);
  }
  ...
  async validateRequest() {
    if (!this.endpointRequestSchema || (0, _lodash2.default)(this.endpointRequestSchema)) {
      return true;
    }
  ...
  async validateResponse(responseType, response) {
    ...
    if (!responseSchema || !(0, _lodash2.default)(responseSchema)) {
      return true;
    }
